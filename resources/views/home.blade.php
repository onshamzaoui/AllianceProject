...
<head>
 ...
 <![endif]-->
    ...
    <link rel="stylesheet" type="text/css" href="lms/vendors/revolution/css/layers.css">
    <link rel="stylesheet" type="text/css" href="lms/vendors/revolution/css/settings.css">
    <link rel="stylesheet" type="text/css" href="lms/vendors/revolution/css/navigation.css">
...
<body id="bg">
            ...
            <div class="sticky-header navbar-expand-lg">
                <div class="menu-bar clearfix">
                    <div class="container clearfix">
                        <!-- Header Logo ==== -->
                        <div class="menu-logo">
                            <a href="index.html"><img src="lms/images/logo-white.png" alt=""></a>
                        </div>
                        <!-- Mobile Nav Button ==== -->
                        ...
                        <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                            <div class="menu-logo">
                                <a href="index.html"><img src="lms/images/logo.png" alt=""></a>
                            </div>
                                ...
                                <li class="add-mega-menu"><a href="javascript:;">Our Courses <i
                                    ...
                                    <ul class="sub-menu add-menu">
                                        ...
                                        <li class="add-menu-right">
                                            <img src="lms/images/adv/adv.jpg" alt="" />
                                        </li>
                                    </ul>
                                </li>
        ...
        <div class="page-content bg-white">
                    ...
                    <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;"
                        ...
                        <ul>
                            ...
                            <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default"
                                ...
                                <!-- MAIN IMAGE -->
                                <img src="lms/images/slider/slide1.jpg" alt="" data-bgposition="center center"
                        ...
                        latest topics
                                ...
                                <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-100-layer-4"
                                    ...
                                    data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                    data-paddingleft="[0,0,0,0]"
                                    style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:130px; font-weight:400;">
                                    Sign up as
                                </div>
								...
								<a href="/etudiant/signup">

									<div class="tp-caption Newspaper-Button rev-btn mx-5" id="slide-100-layer-6"
                                    data-x="['center','center','center','center']"
                                    data-hoffset="['-90','-80','-75','-90']" data-y="['top','top','top','top']"
                                    data-voffset="['400','400','400','420']" data-width="none" data-height="none"
                                    data-whitespace="nowrap" data-type="button" data-responsive_offset="on"
                                    ...
                                    data-paddingtop="[12,12,12,12]" data-paddingright="[30,35,35,15]"
                                    data-paddingbottom="[12,12,12,12]" data-paddingleft="[30,35,35,15]"
                                    style="margin-right: 10px !important; z-index: 8;  white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; border-radius:30px;">
                                    Student</div>
								</a>
								</li>
                                ...
                                data-thumb="lms/images/slider/slide1.jpg" data-rotate="0" data-fstransition="fade"
                                ...
                                data-description="Science says that Women are generally happier">
                                <!-- MAIN IMAGE -->
                                <img src="lms/images/slider/slide2.jpg" alt="" data-bgposition="center center"
                                    data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10"
                                    class="rev-slidebg" data-no-retina />
            ...
            <div class="content-block">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    <div class="action-box">
                                        <img src="lms/images/our-services/pic1.jpg" alt="">
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    <div class="action-box">
                                        <img src="lms/images/our-services/pic2.jpg" alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        <div class="feature-box-sm radius bg-white">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="service-bx m-b0">
                                    <div class="action-box">
                                        <img src="lms/images/our-services/pic3.jpg" alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        <div class="feature-box-sm radius bg-white">
                        ...
                        <div class="row">
                            <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                                <div class="item">
                                    <div class="cours-bx">
                                        <div class="action-box">
                                            <img src="lms/images/courses/pic1.jpg" alt="">
                                            <a href="#" class="btn">Read More</a>
                                        </div>
                                        <div class="info-bx text-center">
                                            <h5><a href="#">Introduction Alliance – LMS plugin</a></h5>
                                ...
                                <div class="item">
                                    <div class="cours-bx">
                                        <div class="action-box">
                                            <img src="lms/images/courses/pic2.jpg" alt="">
                                            <a href="#" class="btn">Read More</a>
                                        </div>
                                        <div class="info-bx text-center">
                                            <h5><a href="#">Introduction Alliance – LMS plugin</a></h5>
                                ...
                                <div class="item">
                                    <div class="cours-bx">
                                        <div class="action-box">
                                            <img src="lms/images/courses/pic3.jpg" alt="">
                                            <a href="#" class="btn">Read More</a>
                                        </div>
                                        <div class="info-bx text-center">
                                            <h5><a href="#">Introduction Alliance – LMS plugin</a></h5>
                                ...
                                <div class="item">
                                    <div class="cours-bx">
                                        <div class="action-box">
                                            <img src="lms/images/courses/pic4.jpg" alt="">
                                            <a href="#" class="btn">Read More</a>
                                        </div>
                                        <div class="info-bx text-center">
                                            <h5><a href="#">Introduction Alliance – LMS plugin</a></h5>
                ...
                <div class="section-area section-sp1 ovpr-dark bg-fix online-cours"
                    style="background-image:url(lms/images/background/bg1.jpg);">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6">
                                    <div class="cours-search-bx m-b30">
                                        <div class="icon-box">
                                            <h3><i class="ti-user"></i><span class="counter">5</span>M
                                            </h3>
                                        </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="cours-search-bx m-b30">
                                        <div class="icon-box">
                                            <h3><i class="ti-book"></i><span class="counter">30</span>K
                                            </h3>
                                        </div>
                        ...
                        <div class="row">
                            <div
                                ...
                                <div class="item">
                                    <div class="event-bx">
                                        <div class="action-box">
                                            <img src="lms/images/event/pic4.jpg" alt="">
                                        </div>
                                        <div class="info-bx d-flex">
                                            ...
                                            <div class="event-info">
                                                <h4 class="event-title"><a href="#">Education Autumn Tour 2019</a>
                                                </h4>
                                                <ul class="media-post">
                                                    <li><a href="#"><i class="fa fa-clock-o"></i> 7:00am 8:00am</a>
                                                    </li>
                                ...
                                <div class="item">
                                    <div class="event-bx">
                                        <div class="action-box">
                                            <img src="lms/images/event/pic3.jpg" alt="">
                                        </div>
                                        <div class="info-bx d-flex">
                                            <div>
                                                <div class="event-time">
                                ...
                                <div class="item">
                                    <div class="event-bx">
                                        <div class="action-box">
                                            <img src="lms/images/event/pic2.jpg" alt="">
                                        </div>
                                        <div class="info-bx d-flex">
                                            <div>
                                                <div class="event-time">
                    ...
                    <div class="container">
                        ...
                        <div class="testimonial-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                            <div class="item">
                                <div class="testimonial-bx">
                                    <div class="testimonial-thumb">
                                        <img src="lms/images/testimonials/pic1.jpg" alt="">
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonial-bx">
                                    <div class="testimonial-thumb">
                                        <img src="lms/images/testimonials/pic2.jpg" alt="">
                                    </div>
                                    <div class="testimonial-info">
                                        <h5 class="name">Peter Packer</h5>
                                        <p>-Art Director</p>
                        ...
                        <div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                            <div class="item">
                                <div class="recent-news">
                                    <div class="action-box">
                                        <img src="lms/images/blog/latest-blog/pic1.jpg" alt="">
                                    </div>
                                    <div class="info-bx">
                                        <ul class="media-post">
                                        ...
                                        <h5 class="post-title"><a href="blog-details.html">This Story Behind
                                                Education Will Haunt You Forever.</a></h5>
                            ...
                            <div class="item">
                                <div class="recent-news">
                                    <div class="action-box">
                                        <img src="lms/images/blog/latest-blog/pic2.jpg" alt="">
                                    </div>
                                    <div class="info-bx">
                                        <ul class="media-post">
                                        ...
                                        <h5 class="post-title"><a href="blog-details.html">What Will Education Be
                                                Like In The Next 50 Years?</a></h5>
                            ...
                            <div class="item">
                                <div class="recent-news">
                                    <div class="action-box">
                                        <img src="lms/images/blog/latest-blog/pic3.jpg" alt="">
                                    </div>
                                    <div class="info-bx">
                                        <ul class="media-post">
                            ...
                            <div class="widget">
                                ...
                                <div class="subscribe-form m-b20">
                                    <form class="subscription-form"
                                        action="http://educhamp.themetrades.com/demo/lms/script/mailchamp.php"
                                        method="post">
                        ...
                        <div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
                            <div class="widget widget_gallery gallery-grid-4">
                                ...
                                <ul class="magnific-image">
                                    <li><a href="lms/images/gallery/pic1.jpg" class="magnific-anchor"><img
                                                src="lms/images/gallery/pic1.jpg" alt=""></a></li>
                                    <li><a href="lms/images/gallery/pic2.jpg" class="magnific-anchor"><img
                                                src="lms/images/gallery/pic2.jpg" alt=""></a></li>
                                    <li><a href="lms/images/gallery/pic3.jpg" class="magnific-anchor"><img
                                                src="lms/images/gallery/pic3.jpg" alt=""></a></li>
                                    <li><a href="lms/images/gallery/pic4.jpg" class="magnific-anchor"><img
                                                src="lms/images/gallery/pic4.jpg" alt=""></a></li>
                                    <li><a href="lms/images/gallery/pic5.jpg" class="magnific-anchor"><img
                                                src="lms/images/gallery/pic5.jpg" alt=""></a></li>
                                    <li><a href="lms/images/gallery/pic6.jpg" class="magnific-anchor"><img
                                                src="lms/images/gallery/pic6.jpg" alt=""></a></li>
                                    <li><a href="lms/images/gallery/pic7.jpg" class="magnific-anchor"><img
                                                src="lms/images/gallery/pic7.jpg" alt=""></a></li>
                                    <li><a href="lms/images/gallery/pic8.jpg" class="magnific-anchor"><img
                                                src="lms/images/gallery/pic8.jpg" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script src="lms/vendors/revolution/js/jquery.themepunch.tools.min.js"></script>
    <script src="lms/vendors/revolution/js/jquery.themepunch.revolution.min.js"></script>
    <!-- Slider revolution 5.0 Extensions  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->
    <script src="lms/vendors/revolution/js/extensions/revolution.extension.actions.min.js"></script>
    <script src="lms/vendors/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
    <script src="lms/vendors/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
    <script src="lms/vendors/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
    <script src="lms/vendors/revolution/js/extensions/revolution.extension.migration.min.js"></script>
    <script src="lms/vendors/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
    <script src="lms/vendors/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
    <script src="lms/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
    <script src="lms/vendors/revolution/js/extensions/revolution.extension.video.min.js"></script>
    <script>
        jQuery(document).ready(function() {
            ...
            if (tpj("#rev_slider_486_1").revolution == undefined) {
                ...
                ttrevapi = tpj("#rev_slider_486_1").show().revolution({
                    sliderType: "standard",
                    jsFileLocation: "lms/vendors/revolution/js/",
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">Alliance</a>
            <button class="navbar-toggler navbar-toggler-right" type="button" data-bs-toggle="collapse"
                data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false"
                aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0 flex justify-center align-items-center">


                    <li class="nav-item"><a class="nav-link" href="#about">About</a></li>
                    <li class="nav-item"><a class="nav-link" href="#services">Categories</a></li>
                    <li class="nav-item"><a class="nav-link" href="#portfolio">formations</a></li>
                    <li class="nav-item"><a class="nav-link" href="#teach">Teach on Alliance</a></li>
                    <li class="nav-item"><a class="nav-link" href="#business">Alliance business</a></li>
                    <li class="nav-item"><i class="nav-link bi-cart fs-4"></i></li>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Get there. From here.</h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">Chart your path to success. Log in for limited-time savings on the
                        latest topics</p>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-white-75 mb-4">Transform knowledge into impact and drive innovation in your
                        organization with Alliance, our flagship online business program.</p>
                    <a class="btn btn-light btn-xl" href="{{ route('home.login') }}">Get Started!</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="page-section" id="services">
        <div class="container px-4 px-lg-5">
            <h2 class="text-center mt-0">Top Categories</h2>
            <hr class="divider" />
            <div class="row gx-4 gx-lg-5">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="mb-2"><i class="bi bi-file-code fs-1 text-primary"></i></div>
                        <h3 class="h4 mb-2"><a href="">Development</a> </h3>
                        <p class="text-muted mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam ipsam
                            delectus debitis vel aliquid saepe, assumenda quod, est laborum incidunt et adipisci.
                            Pariatur, dolor sequi veritatis eveniet optio numquam! Libero.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="mb-2"><i class="bi bi-shop fs-1 text-primary"></i></div>
                        <h3 class="h4 mb-2"><a href="#">Marketing</a></h3>
                        <p class="text-muted mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro,
                            quibusdam accusamus vitae earum quisquam iure ducimus, magni doloribus assumenda est officia
                            repellendus error rerum deserunt, recusandae enim inventore magnam iusto?</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="mb-2"><i class="bi bi-laptop fs-1 text-primary"></i></div>
                        <h3 class="h4 mb-2"><a href="#"> IT and Software</a></h3>
                        <p class="text-muted mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Necessitatibus quasi dolorem commodi minima eveniet, repellat sed vero ad dolores cupiditate
                            enim nostrum quo doloremque consectetur mollitia. Omnis aliquam amet accusamus.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="mb-2"><i class="bi bi-briefcase fs-1 text-primary"></i></div>
                        <h3 class="h4 mb-2"><a href="#">business</a> </h3>
                        <p class="text-muted mb-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis
                            quod excepturi architecto hic quae expedita laudantium, voluptates quidem iusto. Aperiam eum
                            nisi iusto eligendi quod vel vitae necessitatibus ipsum animi.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="portfolio">
        <div class="container-fluid p-0">
            <h2 class="text-center mt-0">Featured topics by Category</h2>
            <hr class="divider" />
            <div class="row g-0">
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{asset('lms/assets/img/portfolio/fullsize/1.jpg')}}" title="Details">
                        <img class="img-fluid" src="{{asset('assets/assets/img/portfolio/thumbnails/1.jpg')}}" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Development</div>
                            <div class="project-name">Python</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{asset('assets/assets/img/portfolio/fullsize/1.jpg')}}" title="Details">
                        <img class="img-fluid" src="{{asset('assets/assets/img/portfolio/thumbnails/1.jpg')}}" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">business</div>
                            <div class="project-name">financial Analysis</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{asset('assets/assets/img/portfolio/fullsize/1.jpg')}}" title="Details">
                        <img class="img-fluid" src="{{asset('assets/assets/img/portfolio/thumbnails/1.jpg')}}" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">IT and Software</div>
                            <div class="project-name">AWS Certification</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{asset('assets/assets/img/portfolio/fullsize/1.jpg')}}" title="Details">
                        ...
                        <div class="portfolio-box-caption">
                            ...
                            <div class="project-name">Graphic Design</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{asset('assets/assets/img/portfolio/fullsize/1.jpg')}}" title="Details">
                        <img class="img-fluid" src="{{asset('assets/assets/img/portfolio/thumbnails/1.jpg')}}" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Marketing</div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{asset('assets/assets/img/portfolio/fullsize/1.jpg')}}" title="Details">
                        ...
                        <div class="portfolio-box-caption p-3">
                            <div class="project-category text-white-50">Cryptocurrency & blockchain</div>
                            <div class="project-name">NFT(non-fungible tokens)</div>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <!-- <section class="page-section  ">
        <div class=" px-lg-5 text-center h-full">
            <div class="d-flex flex-row justify-content-center align-items-center">
                <div class="bg-primary">
                    <img class="mx-auto" src="https://s.udemycdn.com/home/non-student-cta/instructor-1x-v3.jpg" alt="">
    ...
    <section class="page-section" id="teach">
        <div class=" px-lg-5  h-full">
            <div class="row">
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center ">
                    <h1 class="text-left">Become an instructor</h1>
                    <p class="text-left w-50">Instructors from around the world teach millions of students on Alliance. We provide the tools and skills to teach what you love.</p>
                    <a class="btn btn-dark btn-xl w-50 " href="{{ route('home.signup') }}">start teaching today</a>
            ...
            <div class="row">
                <div class="col-md-6 d-flex flex-column justify-content-center ">
                    <div class="text-left w-75 mx-auto">
                        ...
                        <h1 >Alliance business</h1>
                        <p class="mr-5 w-75 ">Get unlimited access to many of Alliance’s top courses for your team. Learn and improve skills across business, tech, design, and more.</p>
                        <a class="btn btn-dark btn-xl w-50" href="{{ route('home.signupetudiant') }}">Get Alliance business</a>
                    </div>
                    
                </div>
                <div class="col-md-6 text-left   ">
                    <img class="mx-auto" src="https://s.udemycdn.com/home/non-student-cta/ub-1x-v3.jpg" alt="">
